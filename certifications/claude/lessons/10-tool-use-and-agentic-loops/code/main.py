"""配套代码对应：
certifications/claude/lessons/10-tool-use-and-agentic-loops/docs/zh.md
它模拟 Claude 的 tool_use 和 tool_result 内容块顺序。
行为遵循 Anthropic 官方客户端工具和 Messages 文档。
"""
...
def choose_runtime(needs: RuntimeNeeds) -> str:
    """选择工作流、手写循环、Tool Runner 或托管 agent。"""
