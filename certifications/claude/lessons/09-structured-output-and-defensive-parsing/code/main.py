"""配套代码对应：
certifications/claude/lessons/09-structured-output-and-defensive-parsing/docs/zh.md
演示 schema 优先的解析、校验与次数受限的修复。
相关概念遵循 Anthropic 官方结构化输出文档。
"""
...
def parse_and_validate(raw: str, schema: dict[str, Any]) -> Any:
    """只接受一个 JSON 值，然后校验所支持的 schema 子集。"""
    try:
