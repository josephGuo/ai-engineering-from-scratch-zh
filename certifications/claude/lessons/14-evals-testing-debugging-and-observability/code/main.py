"""配套代码：
certifications/claude/lessons/14-evals-testing-debugging-and-observability/docs/zh.md
用于评价输出、tool trajectory、最终状态、延迟与故障。
设计遵循 Anthropic 官方评估指南。
"""
