"""配套代码：
certifications/claude/lessons/13-application-security-and-secrets/docs/zh.md
用于将不可信的模型意图与确定性授权分离。
控制措施遵循 Anthropic 官方安全指南与 OWASP LLM 概念。
"""
