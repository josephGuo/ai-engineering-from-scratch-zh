"""配套代码：
certifications/claude/lessons/08-messages-api-and-application-lifecycle/docs/zh.md
无需网络调用即可建模 Messages API 生命周期。
协议概念遵循 Anthropic Messages API 官方文档。
"""
...
class MessageLifecycle:
    ...
    def run(self, user_text: str) -> RunResult:
        ...
        for turn in range(1, self.max_turns + 1):
            ...
            # 必须在 tool_result 前保留 assistant tool_use 块。
    ...
    def _execute_tool(self, block: dict[str, Any]) -> dict[str, Any]:
        ...
        except Exception as exc:  # 工具失败会变成模型可见的结果。
            return {
                "type": "tool_result",
                "tool_use_id": tool_id,
